                ...
                $scope.showMap = function() {
                    // if(!map){
                        $scope.$apply(function(){
                            $http.get('mapcss.js').success(function(data) {
                                $scope.mapcss = data;
